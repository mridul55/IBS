        ...
        <div class="row row-offcanvas row-offcanvas-right">
          ...
          <?php 
            if (isset($_GET['delid'])) {
              ...
              if ($result) {
                echo "<span class='text-danger'>Delete Successfuly </span>";
              }
            }
            ...
            if (isset($_GET['active'])) {
              ...
              $result = $db->delete($query);
              if ($result) {
                echo "<span class='text-success'>Active Successfuly </span>";
              }
            }
            ...
            if (isset($_GET['inactive'])) {
              ...
              $result = $db->delete($query);
              if ($result) {
                echo "<span class='text-success'>InActive Successfuly </span>";
              }
            }
            ...
            <div class="row">
              <div class="col-sm-12">
                <table class="table">
                    ...
                    <tbody>
                      <?php 
                        $query ="SELECT * from registration where parmition_status='0'";
                      ...
                      <tr>
                        ...
                        <td>
                          <?php 
                          if($data->status == 0){ ?>
                            <a onclick="return confirm('Are You sure to Active!');" href="?active=<?php echo $data->id; ?>"><span class="badge badge-success">Active</span></a>
                           <?php } else{ ?>
                             <a onclick="return confirm('Are You sure to Inactive!');" href="?inactive=<?php echo $data->id; ?>"><span class="badge badge-danger">In active</span></a>
                           <?php } ?>
                        </td>
                        <td claass="btn btn-danger">
